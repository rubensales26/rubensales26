...
- **How to apply metaheuristics in optimization:** Applying **GRASP** and **Path Relinking** methodologies to solve Combinatorial Optimization problems.
- **How to implement numerical methods for simulation:** Turning numerical methods into code that solves different versions of the **Neutron Diffusion Equation**.
